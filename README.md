## mongoose-path-tree
[![Build Status](https://travis-ci.org/destec/mongoose-path-tree-promisify.png)](https://travis-ci.org/destec/mongoose-path-tree-promisify)
...
Install via NPM
    ...
    $ npm install mongoose-path-tree-promisify
...
```javascript
var tree = require('mongoose-path-tree-promisify');
